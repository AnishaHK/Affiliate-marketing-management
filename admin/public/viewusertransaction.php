...
?>
            ...
            >
              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Cash Amount</span>
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="first name" name="fname" required value="<?php
...
$sql3="SELECT * FROM cheque WHERE id=$cid";
$res4=mysqli_query($conn,$sql3);
while($row4=mysqli_fetch_assoc($res4)){

    $cnum=$row4["cheque_number"];
...
<label class="block text-sm">
                ...
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="first name" name="fname" value="<?php
