...
$sql2="SELECT * FROM company WHERE id=$id1";
...
<span class="text-gray-700 dark:text-gray-400">Transaction Date</span>
                ...
                <input 
                  class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                  rows="3"
                  placeholder="Amount in Rs" required name="tr_date"
               type="date" >
...
<form action="transactcompanycheque.php" method="POST">
  ...
  <input type="hidden" method="POST" value="<?php
...
<br><br>
                <img src="http://localhost/project/admin/public/image/<?php
 echo $upi;
